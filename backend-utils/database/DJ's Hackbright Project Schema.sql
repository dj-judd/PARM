...
COMMENT ON COLUMN "currencies"."audit_info_entry_id" IS 'Foreign key to audit information';
...
COMMENT ON COLUMN "email_addersses"."audit_info_entry_id" IS 'Foreign key to audit information';
...
ALTER TABLE "audit_info_entries" ADD FOREIGN KEY ("id") REFERENCES "currencies" ("audit_info_entry_id");
...
ALTER TABLE "audit_info_entries" ADD FOREIGN KEY ("id") REFERENCES "email_addersses" ("audit_info_entry_id");
