...
CREATE INDEX "idx_email_owner_type" ON "email_addresses" ("email_type");
...
COMMENT ON COLUMN "file_attachments"."entity_id" IS 'ID of the entity in its respective table';
...
COMMENT ON COLUMN "email_addresses"."emailable_entity_type" IS 'Type of entity to which an email can be sent';

COMMENT ON COLUMN "email_addresses"."entity_id" IS 'ID of the related owner';
...
COMMENT ON COLUMN "phone_numbers"."phoneable_entity_type" IS 'Type of entity to which phonecall can be made';

COMMENT ON COLUMN "phone_numbers"."entity_id" IS 'ID of the related owner';
