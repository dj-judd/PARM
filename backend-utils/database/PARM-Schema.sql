...
ALTER TABLE "audit_info_entries" ADD FOREIGN KEY ("id") REFERENCES "asset_tags" ("audit_info_entry_id");
...
ALTER TABLE "audit_info_entries" ADD FOREIGN KEY ("id") REFERENCES "brands" ("audit_info_entry_id");
