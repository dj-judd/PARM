...
CREATE TABLE "file_attachment_associations" (
  "file_attachment_id" INT NOT NULL,
  "attachable_entity_type" attachable_entity_types NOT NULL,
  "entity_id" INT NOT NULL,
  PRIMARY KEY ("file_attachment_id", "attachable_entity_type", "entity_id")
);
...
CREATE INDEX "idx_file_attachments_attachable_entity_type" ON "file_attachment_associations" ("attachable_entity_type");

CREATE INDEX "idx_file_attachments_related_entity_id" ON "file_attachment_associations" ("entity_id");

CREATE INDEX "idx_file_attachments_attachable_entity_type_id" ON "file_attachment_associations" ("attachable_entity_type", "entity_id");
...
ALTER TABLE "file_attachment_associations" ADD FOREIGN KEY ("file_attachment_id") REFERENCES "file_attachments" ("id");
