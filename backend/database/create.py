...
def file_attachment_association(file_attachment_id: int,
                               attachable_entity_type: model.AttachableEntityTypes,
                               entity_id: int,
                               created_by_user_id: int,
                               audit_details: Optional[str] = None,
                               commit: bool = True):
    """Create and return a File Attachment Association entry."""

    # Create a new FileAttachmentAssociation
    ...
    file_attachment_association_audit_entry = audit_entry(
        ...
        related_entity_id=file_attachment_association.file_attachment_id,
        created_by_user_id=created_by_user_id,
        audit_details=audit_details
    )
    ...
    return file_attachment_association, file_attachment_association_audit_entry



def file_attachment_with_association(attachable_entity_type: model.AttachableEntityTypes,
                                     entity_id: int,
                                     file_path: str,
                                     file_hash: str,
                                     file_type: model.FileType,
                                     ...
                                     audit_details: Optional[str] = None,
                                     commit: bool = True):
    """Create and return a File Attachment & File Attachment Association entry."""
