...
category_id_mapping = {
    ...
    'Lighting': 42,
    'Modifiers': 43,
    'Reflectors & Diffusion': 44,
    'Holders': 45,
    'Softboxes': 46,
    'Bowens Mount': 53,
    'Barndoors': 48,
    'Snoots': 50,
    'Projection Lenses': 52,
    'Lights': 54,
    'Grip': 56,
    'Stands': 57,
    'Light Stands': 58,
...
category_parent_mapping = {
    ...
    ('Video', 'Cameras'): 3, 
    ('Cameras', 'Drones'): 4, 
    ('Drones', 'Accessories'): 5, 
    ('Cameras', 'Accessories'): 6, 
    ('Video', 'Camera Supports'): 7, 
    ('Camera Supports', 'Tripods'): 8, 
    ('Tripods', 'Accessories'): 9, 
    ('Camera Supports', 'Gimbals'): 10, 
    ('Gimbals', 'Accessories'): 11, 
    ('Video', 'Lenses'): 12, 
    ('Lenses', 'Primes'): 13, 
    ('Lenses', 'Zooms'): 14, 
    ('Video', 'Cables'): 15, 
    ('Cables', 'HDMI'): 16, 
    ('Cables', 'HD-SDI'): 17, 
    ('Cables', 'DisplayPort'): 18, 
    ('Cables', 'Accessories'): 19, 
    ('Video', 'Displays'): 20, 
    ('Displays', 'Desktop'): 21, 
    ('Displays', 'Field'): 22, 
    ('Displays', 'EVF'): 23, 
    ('Displays', 'Accessories'): 24, 
    ('Video', 'Switchers'): 25, 
    (None, 'Audio'): 26, 
    ('Audio', 'Microphones'): 27, 
    ('Microphones', 'XLR'): 28, 
    ('Microphones', '3.5mm | 1/8in'): 29, 
    ('Microphones', 'Accessories'): 30, 
    ('Audio', 'Cables'): 31, 
    ('Cables', 'XLR'): 32, 
    ('Cables', '6.35mm | 1/4in'): 33, 
    ('Cables', '3.5mm | 1/8in'): 34, 
    ('Cables', 'Adapters'): 35, 
    ('Audio', 'Wireless'): 36, 
    ('Audio', 'Recorders'): 37, 
    ('Audio', 'Interfaces'): 38, 
    ('Audio', 'Communications'): 39, 
    ('Communications', 'Radios'): 40, 
    ('Audio', 'Speakers'): 41, 
    (None, 'Lighting'): 42, 
    ('Lighting', 'Modifiers'): 43, 
    ('Modifiers', 'Reflectors & Diffusion'): 44, 
    ('Reflectors & Diffusion', 'Holders'): 45, 
    ('Modifiers', 'Softboxes'): 46, 
    ('Softboxes', 'Bowens Mount'): 47, 
    ('Modifiers', 'Barndoors'): 48, 
    ('Barndoors', 'Bowens Mount'): 49, 
    ('Modifiers', 'Snoots'): 50, 
    ('Snoots', 'Bowens Mount'): 51, 
    ('Modifiers', 'Projection Lenses'): 52, 
    ('Projection Lenses', 'Bowens Mount'): 53, 
    ('Lighting', 'Lights'): 54, 
    ('Lights', 'Accessories'): 55, 
    (None, 'Grip'): 56, 
    ('Grip', 'Stands'): 57, 
    ('Stands', 'Light Stands'): 58, 
    ('Light Stands', 'Rollable'): 59, 
    ('Light Stands', 'Foldable'): 60, 
    ('Light Stands', 'Accessories'): 61, 
    ('Stands', 'C-Stands'): 62, 
    ('Stands', 'Mic Stands'): 63, 
    ('Stands', 'Accessories'): 64, 
    ('Grip', 'Baby Pin Accessories'): 65, 
    ('Grip', 'Sandbags'): 66, 
    ('Grip', 'Stage/Studio'): 67, 
    ('Stage/Studio', 'Backdrops'): 68, 
    ('Stage/Studio', 'Apple Boxes'): 69, 
    (None, 'Computer'): 76, 
    ('Computer', 'iPads'): 71, 
    ('iPads', 'Accessories'): 72, 
    ('Computer', 'Desktops'): 73, 
    ('Computer', 'Laptops'): 74, 
    ('Computer', 'Accessories'): 75, 
    ('Computer', 'Batteries'): 77, 
    ('Batteries', 'V-Mount'): 78, 
    ('V-Mount', 'Chargers'): 79, 
    ('Batteries', 'Gold Mount'): 80, 
    ('Gold Mount', 'Chargers'): 81, 
    ('Batteries', 'NP-F'): 82, 
    ('NP-F', 'Chargers'): 83, 
    ('Batteries', 'BP-U30'): 84, 
    ('BP-U30', 'Chargers'): 85, 
    ('Batteries', 'LP-E6NH'): 86, 
    ('LP-E6NH', 'Chargers'): 87, 
    ('Batteries', 'Mini 2'): 88, 
    ('Mini 2', 'Chargers'): 89, 
    ('Batteries', 'Mavic 3'): 90, 
    ('Mavic 3', 'Chargers'): 91, 
    ('Batteries', 'Ronin 2'): 92, 
    ('Computer', 'Cables'): 93, 
    ('Cables', 'Extension Cords'): 94, 
    (None, 'Storage & Transport'): 95, 
    ('Storage & Transport', 'Cases'): 96, 
    ('Storage & Transport', 'Carts'): 97
}
